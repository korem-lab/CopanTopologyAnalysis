...
#     #    # # degree info for each node
       ...
       # validation
       expand(join(config["validationDir"], "{graph_id}_nodes_no_in_links.txt"), graph_id=GRAPH_IDS),
       expand(join(config["validationDir"], "{graph_id}_{walk_length}Lw{n_walks}Nw{p}p{q}q_nodes_not_in_walksVectorized.txt"),
              graph_id=GRAPH_IDS,
              walk_length=WALK_LENGTHS,
              n_walks=N_WALKS,
              p=P_VALUES,
              q=Q_VALUES),
       expand(join(config["validationDir"], "{graph_id}_{walk_length}Lw{n_walks}Nw{p}p{q}q_nodes_not_in_walksOriented.txt"),
              graph_id=GRAPH_IDS,
              walk_length=WALK_LENGTHS,
              n_walks=N_WALKS,
              p=P_VALUES,
